    ...
    return (
        <div className="lg:w-[70vw] m-[5%] lg:ml-[18vw] xl:ml-[15vw] grid grid-flow-row lg:grid-cols-2 gap-y-16 gap-x-4">
                ...
                <div className="relative bg-white shadow-lg w-full min-h-[20vh] rounded-md ">
                    <div className="absolute ml-5 mt-[-1rem] min-w-[5vw] min-h-[5vh] max-h-[18vh] max-w-[19vh] w-[30vw] h-[18vh] lg:w-[15vw] lg:h-[15vh] rounded-md">
                        <Image className="w-[auto] h-[auto]" alt="transfer image" src={tranferImg} />
                    </div>
                ...
                <div className="relative bg-white shadow-lg w-full min-h-[20vh] rounded-md ">
                    <Image className="absolute ml-5 mt-[-1rem] min-w-[5vw] min-h-[5vh] max-h-[18vh] max-w-[19vh] w-[30vw] h-[18vh] lg:w-[15vw] lg:h-[15vh] rounded-md" alt="transfer image" src={transferImg2} />
